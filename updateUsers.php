  ...
  <div class="content-update">
    ...
    <div class="efetuar-cadastro">
      <form action="cadastroUsers_exe.php" method="post" onsubmit="return check(this.form)">
        ...
        <input type="hidden" id="updateForm" name="updateForm" value="Atualizar">
        ...
        <!-- <a href="." onclick="onOffUpdate()">Voltar</a>
        <button>Salvar</button> -->
        <!-- <input type="button" value="Voltar" class="bt-update-voltar" onclick="window.location.href='.'"> -->
