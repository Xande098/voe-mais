...
$(function () {
  var width = (parseInt($('.items-carrosel .image-carrosel').outerWidth()
    + parseInt($('.items-carrosel .image-carrosel').css('margin-right'))))
    * $('.items-carrosel .image-carrosel').length;
  $('.items-carrosel').css('width', width);
